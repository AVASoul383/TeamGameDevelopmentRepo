    ...
    class ColorCorrectionLookupEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (texture.objectReferenceValue != null)
            {
                ...
                {
                    // Fix texture format validation (new API)
                    if (!textureImporter.isReadable || textureImporter.textureCompression != TextureImporterCompression.Uncompressed || textureImporter.mipmapEnabled)
                    {
